...
// 🔥 Dynamic Label Logic (Controller se aane wala $type variable use hoga)
$pageType = $type ?? 'post'; 
                            ...
                            <?php if(!empty($reports)): ?>
                                ...
                                <?php 
                                    ...
                                    if ($item->status == 'pending' && !empty($item->locked_by) && $item->locked_by != $currentAdminId) {
                                        // Check if lock is within 15 mins timeout
                                ...
                                <tr style="border-bottom: 1px solid var(--border-soft);">
                                    ...
                                    <td class="align-middle">
                                        ...
                                        <div class="mt-1 d-flex align-items-center">
                                            <span class="badge" style="background: #f4f7fa; color: var(--text-dark); font-size: 9px; border: 1px solid var(--border-soft);"><?= $idLabel ?>: <?= $item->reportable_id ?></span>
                                    ...
                                    <td class="align-middle text-right px-4">
                                        <div class="btn-group">
                                            <?php if($isLocked): ?>
                                                <button type="button" class="action-btn-pro btn-locked" title="Admin ID #<?= $item->locked_by ?> is currently reviewing this.">
