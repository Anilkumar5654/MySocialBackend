...
$currentFilter = $request->getGet('status') ?? 'pending'; // Default pending filter

// 🔥 Dynamic Label Logic
$pageType = $type ?? 'post'; 
$displayTitle = ucfirst($pageType) . ' Reports';
$idLabel = strtoupper($pageType) . ' ID';
?>
...
<style>
    ...
    .stat-card-pro:hover { transform: translateY(-5px); box-shadow: 0 10px 20px rgba(0,0,0,0.08); }
    ...
    @media (max-width: 768px) {
        .stat-card-pro { padding: 12px; text-align: center; }
        .stat-label-pro { font-size: 9px; }
        .stat-value-pro { font-size: 18px; }
    }
    ...
    .reporter-avatar-pro { width: 40px; height: 40px; border-radius: 8px; border: 1px solid var(--border-soft); object-fit: cover; background: #f8f9fa; }
    ...
    .st-badge-pro { font-size: 10px; padding: 5px 12px; border-radius: 4px; font-weight: 800; text-transform: uppercase; letter-spacing: 0.5px; }
    ...
    .btn-locked { background: #f8f9fa; color: #ccc !important; cursor: not-allowed; }
</style>
    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center">
            <h1 style="color: var(--text-dark); font-weight: 700; letter-spacing: -0.5px;">
                <i class="fas fa-shield-alt mr-2 text-primary"></i> <?= $displayTitle ?>
            </h1>
...
<section class="content">
    <div class="container-fluid">
        ...
        <div class="card shadow-sm border-0 mb-4" style="border-radius: 12px;">
            <div class="card-body">
                <form method="get">
                    <input type="hidden" name="status" value="<?= esc($currentFilter) ?>">
                    <div class="row align-items-end">
                        <div class="col-md-11 mb-2">
                            <label class="small text-muted font-weight-bold">SEARCH REPORTS</label>
                            <input type="text" name="search" class="form-control form-control-pro" placeholder="Reporter name, reason or ID..." value="<?= esc($request->getGet('search') ?? '') ?>">
                        </div>
                        <div class="col-md-1 mb-2">
                            <button type="submit" class="btn btn-block shadow-sm text-white" style="background: var(--primary-blue); border-radius: 8px; height: 45px; border: none;">
                    ...
                    <table class="table table-hover mb-0" style="min-width: 800px;">
                        <thead style="background: #f8f9fa; color: var(--text-dark); text-transform: uppercase; font-size: 11px;">
                            <tr>
                                ...
                                <th class="py-4 border-0">Timestamp</th>
                                ...
                                <tr style="border-bottom: 1px solid var(--border-soft);">
                                    <td class="align-middle px-4">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                <div class="text-dark font-weight-bold" style="font-size: 14px;"><?= esc($item->reporter_name ?? 'User') ?></div>
                                    ...
                                    <td class="align-middle">
                                        ...
                                        <div class="mt-1 d-flex align-items-center">
                                            <span class="badge mr-2" style="background: #f4f7fa; color: var(--text-dark); font-size: 9px; border: 1px solid var(--border-soft);"><?= $idLabel ?>: <?= $item->reportable_id ?></span>
                                    ...
                                    <td class="align-middle text-right px-4">
                                        <div class="btn-group">
                                            <?php if($isLocked): ?>
                                                <button type="button" class="action-btn-pro btn-locked" title="Locked by another admin">
                                            ...
                                            <button type="button" class="action-btn-pro delete-report-btn" 
                                                    data-id="<?= $item->id ?>" style="color: var(--accent-red);"
                                                    title="Delete Log">
    ...
    document.addEventListener('click', function (e) {
        ...
        if (btn) {
            ...
            Swal.fire({
                ...
                text: "This removes the log from the system history.",
                icon: 'warning',
