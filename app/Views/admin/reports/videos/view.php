...
<style>
    ...
    .video-wrapper-pro { width: 100%; background: #000; border-radius: 12px; overflow: hidden; border: 1px solid var(--border-soft); position: relative; padding-top: 56.25%; }
    .video-player-pro { position: absolute; top: 0; left: 0; width: 100%; height: 100%; }
    .content-img-pro { width: 100%; max-height: 500px; object-fit: contain; border-radius: 12px; border: 1px solid var(--border-soft); background: #f8f9fa; display: block; margin: 0 auto; }
    ...
    .btn-action-pro { 
        ...
        margin-bottom: 12px; border-radius: 8px; transition: 0.3s; border: none; font-size: 13px;
    }
    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center">
            <h1 style="color: var(--text-dark); font-weight: 700; letter-spacing: -0.5px;">
                <i class="fas fa-search mr-2 text-primary"></i> Review Report
            </h1>
            ...
            <div class="col-lg-8">
                <div class="card-pro">
                    <div class="card-header-pro d-flex justify-content-between align-items-center">
                        <h6 class="text-dark m-0 font-weight-bold"><i class="fas fa-file-alt mr-2 text-primary"></i> CONTENT DETAILS</h6>
                        ...
                        <?php if($content): ?>
                            <div class="mb-4 text-center">
                                ...
                                <?php if($mediaType == 'post_image'): ?>
                                    <img src="<?= $finalUrl ?>" class="content-img-pro" alt="Reported Content">
                                <?php else: ?>
                            ...
                            <p class="text-muted small mb-0"><i class="far fa-calendar-alt mr-1"></i> Uploaded on: <?= date('d M Y, h:i A', strtotime($content->created_at)) ?></p>
                        <?php else: ?>
                ...
                <div class="card-pro">
                    <div class="card-body">
                        <div class="d-flex align-items-start">
                            ...
                            <div style="flex: 1;">
                                <h6 class="text-dark font-weight-bold mb-3">Reported By: <span class="text-primary"><?= esc($report->reporter_name ?? 'User') ?></span></h6>
                                <div class="row">
                                    <div class="col-md-6 mb-3 mb-md-0">
                                        <div class="label-pro">Violation Reason</div>
            ...
            <div class="col-lg-4">
                <div class="card-pro">
                    <div class="card-header-pro text-center">
                        <h6 class="text-dark m-0 font-weight-bold">OWNER INFO</h6>
                    </div>
                ...
                <div class="card-pro" style="border-top: 3px solid var(--primary-blue);">
                    <div class="card-header-pro text-center bg-white">
                        <h6 class="text-dark m-0 font-weight-bold">TAKE ACTION</h6>
                    </div>
                    <div class="card-body">
                        ...
                        <?php else: ?>
                            <div class="text-center py-3">
                                <?php if($report->status == 'resolved'): ?>
                                    ...
                                    <h5 class="text-dark font-weight-bold">RESOLVED</h5>
                                <?php else: ?>
...
<script>
/**
 * 🚀 FIXED: Native Logic with Professional Theme Alerts
 */
document.addEventListener("DOMContentLoaded", function() {
    window.confirmAction = function(actionType) {
        ...
        else if(actionType === 'ban_user') { title='Ban User Account?'; text='This will block the creator from the platform.'; color='#fd397a'; btnText='Yes, Ban User'; }
