    ...
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center">
            <h1 style="color: var(--text-dark); font-weight: 700; letter-spacing: -0.5px;">
                <i class="fas fa-search-plus mr-2 text-primary"></i> Review Report
            </h1>
                ...
                <div class="card-pro">
                    ...
                    <div class="card-body">
                        <?php if($content): ?>
                            ...
                            <h4 class="black-text mt-3"><?= esc($content->title ?? $content->caption ?? $content->content ?? 'Untitled') ?></h4>
...
document.addEventListener("DOMContentLoaded", function() {
    window.confirmAction = function(actionType) {
        ...
        Swal.fire({
            ...
            input: 'text', inputPlaceholder: 'Reason for action...',
